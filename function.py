...
def chat_log(message):
    ...
    chat_log = str('ID: ' + message.from_user.id + '    Name: ' + message.from_user.first_name + '   Username: ' + message.from_user.username + '   Last Name: ' + message.from_user.last_name + '     Says: ' + message.text )
    return chat_log
